...
class Logger:
    ...
    def save_models(
        ...
        if self.do_checkpoints(step) or final:
            ...
            self.set_forward_policy_ckpt_path(ckpt_id=ckpt_id)
            ...
            self.set_backward_policy_ckpt_path(ckpt_id=ckpt_id)
            if (
                backward_policy
    ...
    def log_time(self, times: dict, step: int, use_context: bool):
        if self.do.times:
            ...
            self.log_metrics(times, step = step, use_context=use_context)
